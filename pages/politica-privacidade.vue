  ...
  <page>
    <div class="container mb-40">
      <div class="text-center mb-40 mt-40">
        <section-title>POLÍTICA DE PRIVACIDADE</section-title>
      </div>
      <div class="mb-10 mt-10">
        <section-subtitle>SEÇÃO 1 - O QUE FAZEMOS COM AS SUAS INFORMAÇÕES?</section-subtitle>
      </div>
      <p>
      ...
      <div class="mb-10 mt-10">
        <section-subtitle>SEÇÃO 2 - CONSENTIMENTO</section-subtitle>
      </div>
      <p>
        ...
        Caso depois de fornecer seus dados você mude de ideia, você pode retirar o seu consentimento quando quiser e assim evitar que entremos em contato para obter ou divulgar informações. Entre em contato conosco através do rafael@geek4geek.com.br ou por correio: Geek4Geek Brasil
      </p>
      <div class="mb-10 mt-10">
        <section-subtitle>SEÇÃO 3 - DIVULGAÇÃO</section-subtitle>
      </div>
      ...
      <div class="mb-10 mt-10">
        <section-subtitle>SEÇÃO 4 - SERVIÇOS DE TERCEIROS</section-subtitle>
      </div>
      <p>
      ...
      <div class="mb-10 mt-10">
        <section-subtitle>SEÇÃO 5 - SEGURANÇA</section-subtitle>
      </div>
      <p>
        ...
        COOKIES
        Segue uma lista dos cookies que usamos. Nós os listamos para que você possa escolher se você quer optar pelos cookies.
        _session_id, token único, por sessão, Permite ao Shopify armazenar informações sobre sua sessão (referenciador, landing page, etc.)
        _shopify_visit, nenhum dado retido, Persistente por 30 minutos da última visita, Usado pelo rastreador de estatísticas interno do provedor do site para gravar o número de visitas
        _shopify_uniq, nenhum dado retido, expira à meia-noite (relativo ao visitante) do próximo dia, Conta o número de visitas de uma loja de um único cliente.
        carrinho, token único, persistente por 2 semanas, Armazena informações sobre os itens do seu carrinho.
        _secure_session_id, token único, por sessão
        storefront_digest, token único, indefinido, Se a loja tem uma senha, ela é usada para determinar se o visitante atual tem acesso.
      </p>
      <div class="mb-10 mt-10">
        <section-subtitle>SEÇÃO 6 - IDADE DE CONSENTIMENTO</section-subtitle>
      </div>
      <p>Ao usar esse site, você confirma que você é maior de idade em seu estado ou província de residência e que você nos deu seu consentimento para permitir que qualquer um dos seus dependentes menores de idade usem esse site.</p>
      <div class="mb-10 mt-10">
        <section-subtitle>SEÇÃO 7 - ALTERAÇÕES NA POLÍTICA DE PRIVACIDADE</section-subtitle>
      </div>
      <p>
        ...
        Se você gostaria de acessar, corrigir, alterar ou excluir quaisquer informações pessoais que temos sobre você, registre uma queixa, ou simplesmente peça mais informações de contato a(o) nosso(a) Diretor(a) de privacidade através do rafael@geek4geek.com.br ou pelo correio: Geek4Geek Brasil
      </p>
      <div class="post-politic">
        <p>
          Possui alguma dúvida ?
          <a href="#">Entre em contato</a> conosco!
        </p>
      </div>
    </div>
  </page>
